...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
	...
	public function getQuickShopButton($_product, $class = ''){
		...
		if($this->scopeConfig->getValue('quickshop/general/active',$this->_scopeStore)){
			...
			$html  = "<a class=\"action qs-button {$class}\" href=\"javascript:void(0)\" data-href=\"{$quickShopUrl}\" title=\"{$quickShopLabel}\">";
			$html .= "<span class='icon ib ib-hover ic ic-compare '></span><span class='label'>{$quickShopLabel}</span>";
			$html .= "</a>";
